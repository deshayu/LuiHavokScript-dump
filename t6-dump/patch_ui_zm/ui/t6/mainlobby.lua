...
CoD.MainLobby.ShouldPreventCreateLobby = function ()
	if UIExpression.AcceptingInvite() == 1 or Engine.IsJoiningAnotherParty() == or UIExpression.PrivatePartyHost() == 0 or Engine.IsGameLobbyRunning() then
		return true
	else
		return false
	end
...
CoD.MainLobby.UpdateButtonPaneButtonVisibilty_Multiplayer = function (MainLobbyButtonPane)
	if CoD.isPartyHost() then
		...
		MainLobbyButtonPane.body.matchmakingButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.leaguePlayButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		if not Engine.IsBetaBuild() then
			MainLobbyButtonPane.body.customGamesButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		end
		MainLobbyButtonPane.body.theaterButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.postTheaterSpacer:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
	end
end
...
CoD.MainLobby.UpdateButtonPaneButtonVisibilty_Zombie = function (MainLobbyButtonPane)
	if CoD.isPartyHost() then
		...
		MainLobbyButtonPane.body.matchmakingButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.soloPlayButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.customSpacer:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.customGamesButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.theaterButton:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.theaterSpacer:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
		MainLobbyButtonPane.body.optionSpacer:closeAndRefocus(MainLobbyButtonPane.body.codtvButton)
	end
end
...
CoD.MainLobby.PopulateButtons_Multiplayer = function (MainLobbyButtonPane)
	if Engine.IsBetaBuild() then
		...
		MainLobbyButtonPane.body.leaguePlayButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_LEAGUE_PLAY_CAPS"), nil, 1)
	else
	...
	if Engine.IsBetaBuild() then
		MainLobbyButtonPane.body.codtvButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_FILESHARE_COMMUNITY_CAPS"), nil, 6)
	else
		MainLobbyButtonPane.body.codtvButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_COD_TV_CAPS"), nil, 6)
	end
	...
	if not CoD.isWIIU and Dvar.ui_inGameStoreVisible:get() == true and (CoD.isPS3 ~= true or CoD.isZombie ~= true) then
		MainLobbyButtonPane.body.ingameStoreButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_INGAMESTORE"), nil, 12)
		if CoD.isPC then
			MainLobbyButtonPane.body.ingameStoreButton.hintText = Engine.Localize("PLATFORM_STORE_DESC")
		else
			MainLobbyButtonPane.body.ingameStoreButton.hintText = Engine.Localize("MENU_STORE_DESC")
		end
		MainLobbyButtonPane.body.ingameStoreButton:setActionEventName("open_store")
	end
end
...
CoD.MainLobby.PopulateButtons_Zombie = function (MainLobbyButtonPane)
	...
	if Engine.IsBetaBuild() then
		MainLobbyButtonPane.body.codtvButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_FILESHARE_COMMUNITY_CAPS"), nil, 7)
	else
		MainLobbyButtonPane.body.codtvButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_COD_TV_CAPS"), nil, 7)
	end
	MainLobbyButtonPane.body.codtvButton.hintText = Engine.Localize("MPUI_COD_TV_DESC")
	MainLobbyButtonPane.body.codtvButton:setActionEventName("open_cod_tv")
	...
	if Dvar.ui_inGameStoreVisible:get() == true and (CoD.isPS3 ~= true or CoD.isZombie ~= true) then
		MainLobbyButtonPane.body.ingameStoreButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_INGAMESTORE"), nil, 11)
		if CoD.isPC then
			MainLobbyButtonPane.body.ingameStoreButton.hintText = Engine.Localize("PLATFORM_STORE_DESC")
		else
			MainLobbyButtonPane.body.ingameStoreButton.hintText = Engine.Localize("MENU_STORE_DESC")
