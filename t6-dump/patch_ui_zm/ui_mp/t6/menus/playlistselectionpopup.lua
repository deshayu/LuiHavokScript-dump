...
CoD.PlaylistSelection.AddSearchPreferencesButtonPrompt = function (f12_arg0)
	...
	local f12_local2 = Engine.Localize("MPUI_SEARCH_PREFERENCES")
	local f12_local3 = f12_arg0
	local f12_local4 = "button_prompt_search_preferences"
	local f12_local5, f12_local6 = false
	local f12_local7, f12_local8 = false
	f12_arg0.searchPreferencesButton = f12_local0(f12_local1, f12_local2, f12_local3, f12_local4, f12_local5, f12_local6, f12_local7, f12_local8, "S")
