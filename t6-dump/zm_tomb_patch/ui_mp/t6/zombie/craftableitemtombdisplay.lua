...
CoD.CraftableItemTombDisplay.AddDisplayContainer = function (f2_arg0, f2_arg1, f2_arg2, f2_arg3, f2_arg4)
	...
	for f2_local1 = 1, #CoD.CraftableItemTombDisplay.ClientFieldNames[f2_local0], 1 do
		...
		for f2_local9, Widget in ipairs(CoD.CraftableItemTombDisplay.Groups[f2_local0]) do
	...
	for f2_local4 = 1, #CoD.CraftableItemTombDisplay.Groups[f2_local0], 1 do
		...
		Widget:setLeftRight(true, false, f2_local1, f2_local1 + f2_local9)
		Widget:setTopBottom(true, false, f2_local2, f2_local2 + CoD.CraftableItemTombDisplay.ContainerSize + f2_arg4)
		if not f2_arg2 then
			Widget:setAlpha(0)
		end
		Widget.id = Widget.id .. ".CraftGroupContainer"
		f2_arg0:addElement(Widget)
		Widget:registerEventHandler("craft_group_fade_out", CoD.CraftableItemTombDisplay.FadeoutGroupContainer)
		Widget:registerEventHandler("transition_complete_off_fade_out", CoD.CraftableItemTombDisplay.FadeOutComplete)
		...
		f2_arg0.craftGroups[f2_local4] = Widget
		...
		for f2_local12 = 1, #CoD.CraftableItemTombDisplay.ClientFieldNames[f2_local0], 1 do
			...
			if f2_local15.group == f2_local4 then
				local Widget = LUI.UIElement.new()
				Widget:setLeftRight(true, false, f2_local11, f2_local11 + CoD.CraftableItemTombDisplay.IconSize)
				Widget:setTopBottom(false, true, -CoD.CraftableItemTombDisplay.IconSize, 0)
				Widget.id = Widget.id .. ".IconContainer"
				Widget.groupID = f2_local4
				Widget.inUse = nil
				Widget:addElement(Widget)
				CoD.CraftablesIcon.new(Widget, CoD.CraftableItemTombDisplay.glowBackColor, CoD.CraftableItemTombDisplay.glowFrontColor)
				...
				Widget.icon = f2_local17
				Widget:addElement(f2_local17)
				f2_arg0.craftItems[f2_local12] = Widget
