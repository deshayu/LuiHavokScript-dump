...
CoD.QuestItemTombDisplay.AddQuestStatusDisplay = function (f2_arg0, f2_arg1, f2_arg2, f2_arg3, f2_arg4)
	...
	Widget:setTopBottom(true, false, f2_local2, f2_local2 + CoD.QuestItemTombDisplay.ContainerSize + f2_arg4)
	if not f2_arg2 then
		Widget:setAlpha(0)
	end
	f2_arg0.questStatusContainer = Widget
	...
	for f2_local11 = 1, CoD.QuestItemTombDisplay.QuestClientFieldCount, 1 do
		local Widget = LUI.UIElement.new()
		Widget:setLeftRight(true, false, f2_local7, f2_local7 + CoD.QuestItemTombDisplay.IconSize)
		Widget:setTopBottom(false, true, -CoD.QuestItemTombDisplay.IconSize, 0)
		Widget:addElement(Widget)
		CoD.CraftablesStaffIcon.new(Widget, CoD.QuestItemTombDisplay.glowBackColor, CoD.QuestItemTombDisplay.glowFrontColor)
		...
		f2_arg0.statusIcons[f2_local11] = Widget
