...
CoD.PersistentItemTombDisplay.AddPersistentStatusDisplay = function (f2_arg0, f2_arg1, f2_arg2, f2_arg3, f2_arg4)
	...
	Widget:setTopBottom(true, false, f2_local2, f2_local2 + CoD.PersistentItemTombDisplay.ContainerSize + f2_arg4)
	if not f2_arg2 then
		Widget:setAlpha(0)
	end
	...
	for f2_local8 = 1, CoD.PersistentItemTombDisplay.QuestClientFieldCount, 1 do
		local Widget = LUI.UIElement.new()
		Widget:setLeftRight(true, false, f2_local7, f2_local7 + CoD.PersistentItemTombDisplay.IconSize)
		Widget:setTopBottom(false, true, -CoD.PersistentItemTombDisplay.IconSize, 0)
		if not f2_arg2 then
			Widget:setAlpha(0)
		end
		Widget:addElement(Widget)
		CoD.CraftablesIcon.new(Widget, CoD.PersistentItemTombDisplay.glowBackColor, CoD.PersistentItemTombDisplay.glowFrontColor)
		...
		Widget.icon = f2_local12
		Widget:addElement(f2_local12)
		f2_arg0.statusIcons[f2_local8] = Widget
