...
CoD.CraftableItemDisplay.AddDisplayContainer = function (f2_arg0, f2_arg1, f2_arg2, f2_arg3)
	...
	for f2_local1 = 1, #CoD.CraftableItemDisplay.ClientFieldNames[f2_local0], 1 do
		...
		for f2_local9, Widget in ipairs(CoD.CraftableItemDisplay.Groups[f2_local0]) do
	...
	for f2_local4 = 1, #CoD.CraftableItemDisplay.Groups[f2_local0], 1 do
		...
		Widget:setTopBottom(true, false, f2_local2, f2_local2 + CoD.CraftableItemDisplay.ContainerSize)
		if not f2_arg2 then
			Widget:setAlpha(0)
		end
		Widget.id = Widget.id .. ".CraftGroupContainer"
		f2_arg0:addElement(Widget)
		Widget:registerEventHandler("craft_group_fade_out", CoD.CraftableItemDisplay.FadeoutGroupContainer)
		Widget:registerEventHandler("transition_complete_off_fade_out", CoD.CraftableItemDisplay.FadeOutComplete)
		...
		for f2_local13 = 1, #CoD.CraftableItemDisplay.ClientFieldNames[f2_local0], 1 do
			...
			if f2_local16.group == f2_local4 then
				local Widget = LUI.UIElement.new()
				Widget:setLeftRight(true, false, f2_local12, f2_local12 + CoD.CraftableItemDisplay.IconSize)
				Widget:setTopBottom(false, true, -CoD.CraftableItemDisplay.IconSize, 0)
				Widget.id = Widget.id .. ".IconContainer"
				Widget.groupID = f2_local4
				Widget.inUse = nil
				Widget:addElement(Widget)
				CoD.CraftablesIcon.new(Widget, CoD.CraftableItemDisplay.glowBackColor, CoD.CraftableItemDisplay.glowFrontColor)
				...
				Widget.icon = f2_local18
				Widget:addElement(f2_local18)
				f2_arg0.craftItems[f2_local13] = Widget
