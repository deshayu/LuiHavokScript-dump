...
LUI.createMenu.StartHighlightReel = function (f7_arg0, f7_arg1)
	...
	f7_local3:setTopBottom(true, false, f7_local2, f7_local2 + CoD.textSize.Big)
	f7_local3:setFont(CoD.fonts.Big)
	f7_local3:setAlignment(LUI.Alignment.Left)
	f7_local3:setText(Engine.Localize("MENU_DEMO_HIGHLIGHT_REEL"))
...
LUI.createMenu.CustomizeHighlightReel = function (f10_arg0, f10_arg1)
	...
	f10_local4:setTopBottom(true, false, f10_local3, f10_local3 + CoD.textSize.Big)
	f10_local4:setFont(CoD.fonts.Big)
	f10_local4:setAlignment(LUI.Alignment.Left)
	f10_local4:setText(Engine.Localize("MENU_DEMO_CUSTOMIZE_HIGHLIGHT_REEL"))
	f10_local0:addElement(f10_local4)
...
CoD.DemoHighlightReel.AddDemoHighlightReelInformation = function (f11_arg0)
	...
	Widget:setLeftRight(false, true, -267, -17)
	Widget:setTopBottom(true, false, 7, 167)
	Widget:setupHighlightReelInformationDisplay()
	f11_arg0.safeArea:addElement(Widget)
end
