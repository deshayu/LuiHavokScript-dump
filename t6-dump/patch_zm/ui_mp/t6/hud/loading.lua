CoD.Loading = {}
local CoD.Loading.DidYouKnow.theater = {
...
local CoD.Loading.DidYouKnow.general = {
...
CoD.Loading.GetDidYouKnowString = function ()
	...
	if Engine.GameModeIsMode(CoD.GAMEMODE_THEATER) == true then
		NumberOfTheaterStrings = #CoD.Loading.DidYouKnow.theater
	...
	elseif CoD.isZombie == true then
		NumberOfZombieStrings = #CoD.Loading.DidYouKnow.zombies
