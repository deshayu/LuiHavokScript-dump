...
LUI.createMenu.BuildablesArea = function (f1_arg0)
	...
	if CoD.Zombie.IsDLCMap(CoD.Zombie.DLC3Maps) == false then
		...
		f1_local5:setLeftRight(false, false, f1_local1, f1_local2)
		f1_local5:setTopBottom(false, true, f1_local4, f1_local3)
		f1_local5:setAlpha(0)
		f1_local5:registerEventHandler("transition_complete_off_fade_out", CoD.Buildables.PowerUpIcon_UpdatePosition)
		f1_local0.scaleContainer:addElement(f1_local5)
		f1_local0.pieceIcons = {}
		f1_local0.pieceIcons[0] = f1_local5
		...
		f1_local0:registerEventHandler(CoD.Buildables.ClientFieldBuildableName, CoD.Buildables.Update)
		local f1_local5 = f1_local1 + CoD.Buildables.IconSize + 2
		local f1_local6 = LUI.UIImage.new()
		f1_local6:setLeftRight(false, true, -CoD.Buildables.IconSize - f1_local5, -f1_local5)
		...
		local f1_local7 = f1_local5 + CoD.Buildables.IconSize + 2
