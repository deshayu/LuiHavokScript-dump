...
LUI.createMenu.EditDefaultClasses = function (f1_arg0)
	...
	f1_local0.classOptionsButtonPrompt = f1_local1(f1_local2, f1_local3, f1_local4, f1_local5, f1_local6, f1_local7, f1_local8, f1_local9, "O")
