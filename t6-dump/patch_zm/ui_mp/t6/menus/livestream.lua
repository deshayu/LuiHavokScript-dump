...
LUI.createMenu.LiveStream = function (f20_arg0, f20_arg1)
	...
	if 1 == UIExpression.DvarBool(nil, "webm_encAllowCamera") then
		...
		f20_local5 = {}
		local Widget = Engine.Localize("MENU_OFF_CAPS")
		local Widget = Engine.Localize("MENU_ON_CAPS")
		f20_local4.strings = Widget
		f20_local4.values = {
			0,
			1
		}
	...
	Widget:setLeftRight(false, true, -f20_local4, 0)
	Widget:setTopBottom(true, false, f20_local3, f20_local3 + f20_local5)
	Widget:setAlignment(LUI.Alignment.Left)
	f20_local0:addElement(Widget)
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(true, true, 0, 0)
	Widget:setTopBottom(true, false, 0, f20_local5 - 20)
	...
	Widget:addElement(viewersWidget)
	...
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(true, true, 0, 0)
	Widget:setTopBottom(true, false, 98, 98 + CoD.textSize.Default + 4)
	Widget:addElement(Widget)
	Widget:addElement(CoD.GetInformationContainer())
	...
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(false, false, -f20_local18 / 2, f20_local18 / 2)
	Widget:setTopBottom(false, true, -f20_local19 - 70, -70)
	Widget:setAlignment(LUI.Alignment.Left)
	f20_local0:addElement(Widget)
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(true, false, 0, 120)
	...
	Widget:addElement(f20_local37)
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(true, true, 118, 0)
	Widget:setTopBottom(true, true, 0, 0)
	Widget:addElement(Widget)
	Widget:addElement(CoD.GetInformationContainer())
	local f20_local39 = {}
	...
	local f20_local42 = 4
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(true, false, 15, 15 + f20_local40 + f20_local41)
	Widget:setTopBottom(true, false, 15, 15 + f20_local42 + CoD.textSize.Default)
	Widget:addElement(Widget)
...
CoD.LiveStream.GetViewersIcon = function (f28_arg0, f28_arg1, f28_arg2)
	local f28_local0 = LUI.UIImage.new()
	f28_local0:setLeftRight(true, false, 0, f28_arg1)
	f28_local0:setTopBottom(false, true, -f28_arg2, 0)
	if f28_arg0 ~= nil then
		f28_local0:setImage(f28_arg0)
	end
	return f28_local0
end

CoD.LiveStream.GetViewersText = function (f29_arg0, f29_arg1)
	local f29_local0 = LUI.UITightText.new()
	f29_local0.font = f29_arg0
	f29_local0.fontSize = f29_arg1
	f29_local0:setTopBottom(false, false, -f29_arg1 / 2, f29_arg1 / 2)
	return f29_local0
end

CoD.LiveStream.GetViewersWidget = function (f30_arg0, f30_arg1, f30_arg2, f30_arg3, f30_arg4, f30_arg5)
	local f30_local0 = LUI.UIHorizontalList.new()
	f30_local0:setLeftRight(true, true, 0, 0)
	f30_local0:setTopBottom(false, false, -f30_arg5 / 2, f30_arg5 / 2)
	f30_local0:setSpacing(5)
	f30_local0:setAlignment(f30_arg3)
	f30_local0.font = f30_arg4
	f30_local0.fontSize = f30_arg5
	
	local viewersCountIcon = CoD.LiveStream.GetViewersIcon(f30_arg0, f30_arg1, f30_arg2)
	f30_local0:addElement(viewersCountIcon)
	f30_local0.viewersCountIcon = viewersCountIcon
	
	local viewersCountText = CoD.LiveStream.GetViewersText(f30_arg4, f30_arg5)
	f30_local0:addElement(viewersCountText)
	f30_local0.viewersCountText = viewersCountText
...
CoD.LiveStream.GetStatusWidget = function (f36_arg0, f36_arg1, f36_arg2, f36_arg3)
	local f36_local0 = LUI.UIContainer.new()
	...
	f36_local0:addElement(f36_local1)
...
CoD.LiveStream.AddInGameStatusWidget = function (f37_arg0, f37_arg1, f37_arg2)
	...
	local Widget = LUI.UIElement.new(f37_arg2)
	...
	f37_arg0.safeArea:addElement(Widget)
end
