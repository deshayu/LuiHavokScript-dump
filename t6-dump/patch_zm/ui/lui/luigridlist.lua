...
LUI.UIGridList.new = function (f2_arg0, f2_arg1, f2_arg2)
	...
	Widget.id = "UIGridList"
	Widget.numRows = f2_arg1
	Widget.numCols = f2_arg2
	Widget.setNumRows = LUI.UIGridList.SetNumRows
	Widget.setNumCols = LUI.UIGridList.SetNumCols
	Widget.spacing = LUI.UIGridList.Spacing
	Widget.rowHeight = LUI.UIGridList.RowHeight
	Widget.addElementToRow = LUI.UIGridList.AddElementToRow
	Widget.setSpacing = LUI.UIGridList.SetSpacing
	Widget.setGridRowHeight = LUI.UIGridList.SetGridRowHeight
	Widget:registerEventHandler("gain_focus", LUI.UIGridList.gainFocus)
	Widget.data = LUI.UIContainer.new()
