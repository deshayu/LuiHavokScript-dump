...
LUI.UIVerticalScrollbar.new = function (f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7)
	...
	Widget.id = "LUIVerticalScrollbar"
	...
	Widget:registerEventHandler("list_scroll", LUI.UIVerticalScrollbar.UpdateScrollbar)
	Widget:registerEventHandler("focus_changed", LUI.UIVerticalScrollbar.FocusChanged)
	Widget:registerEventHandler("inactive", LUI.UIVerticalScrollbar.Inactive)
	return Widget
end
