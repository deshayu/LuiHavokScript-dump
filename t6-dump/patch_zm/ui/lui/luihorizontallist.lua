...
LUI.UIHorizontalList.new = function (f2_arg0)
	...
	Widget.id = "LUIHorizontalList"
	Widget:setupUIHorizontalList()
	Widget.addSpacer = f0_local0
	Widget.addElement = LUI.UIHorizontalList.AddElement
	Widget.removeElement = LUI.UIHorizontalList.RemoveElement
	Widget:registerEventHandler("gain_focus", LUI.UIHorizontalList.gainFocus)
	return Widget
end
