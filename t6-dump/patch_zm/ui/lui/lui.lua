...
function DisableGlobals()
	...
	f11_local0.__newindex = function (f13_arg0, f13_arg1, f13_arg2)
		error("LUI Error: Tried to create global variable " .. f13_arg1, 2)
	end

end

function EnableGlobals()
	local f12_local0 = getmetatable(_G)
	if not f12_local0 then
		f12_local0 = {}
		setmetatable(_G, f12_local0)
	end
	f12_local0.__newindex = nil
end
