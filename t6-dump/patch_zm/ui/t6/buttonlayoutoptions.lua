...
CoD.ButtonLayout.AddLeftAlignLabel = function (f11_arg0, f11_arg1, f11_arg2)
	...
	f11_local0:setLeftRight(true, false, f11_arg1, f11_arg1 + 1)
...
CoD.ButtonLayout.AddRightAlignLabel = function (f12_arg0, f12_arg1, f12_arg2)
	...
	f12_local0:setLeftRight(false, true, f12_arg1, f12_arg1 - 1)
...
CoD.ButtonLayout.AddCenterAlignLabel = function (f13_arg0, f13_arg1, f13_arg2)
	...
	f13_local0:setLeftRight(false, false, f13_arg1 - 1, f13_arg1 + 1)
	f13_local0:setTopBottom(true, false, f13_arg2, f13_arg2 + CoD.textSize.Default)
	f13_local0:setRGB(CoD.ButtonLayout.LineColor[1], CoD.ButtonLayout.LineColor[2], CoD.ButtonLayout.LineColor[3])
	f13_local0:setFont(CoD.fonts.Default)
...
CoD.ButtonLayout.AddPS3LinesAndLabels = function (f17_arg0, f17_arg1)
	...
	local f17_local1 = function (f20_arg0)
		return f20_arg0 * 0.98 - 250
	end

	local f17_local2 = function (f21_arg0)
		return f21_arg0 * 0.98 - 175
	end
...
CoD.ButtonLayout.AddWiiULinesAndLabels = function (f18_arg0, f18_arg1)
	CoD.WiiUButtonLayout.AddLinesAndLabels(f18_arg0, f18_arg1)
end

CoD.ButtonLayout.AddXenonLinesAndLabels = function (f19_arg0)
	f19_arg0.buttonLabels = {}
	f19_arg0.buttonLines = {}
	local f19_local0 = -10
	local f19_local1 = 200
	local f19_local2 = 130
	f19_arg0.buttonLines.BUTTON_A = CoD.ButtonLayout.AddLine(f19_arg0, {
		120,
		88
	}, {
		f19_local1,
	...
	f19_arg0.buttonLabels.BUTTON_A = CoD.ButtonLayout.AddLeftAlignLabel(f19_arg0, f19_local1 + 5, f19_local2 + f19_local0)
	local f19_local3 = 200
	local f19_local4 = 60
	f19_arg0.buttonLines.BUTTON_B = CoD.ButtonLayout.AddLine(f19_arg0, {
		163,
		44
	}, {
		f19_local3,
	...
	f19_arg0.buttonLabels.BUTTON_B = CoD.ButtonLayout.AddLeftAlignLabel(f19_arg0, f19_local3 + 5, f19_local4 + f19_local0)
	local f19_local5 = 205
	local f19_local6 = 95
	f19_arg0.buttonLines.BUTTON_X = CoD.ButtonLayout.AddLine(f19_arg0, {
		100,
		44
	}, {
		f19_local5,
	...
	f19_arg0.buttonLabels.BUTTON_X = CoD.ButtonLayout.AddLeftAlignLabel(f19_arg0, f19_local5 + 5, f19_local6 + f19_local0)
	local f19_local7 = 195
	local f19_local8 = 25
	f19_arg0.buttonLines.BUTTON_Y = CoD.ButtonLayout.AddLine(f19_arg0, {
		132,
		10
	}, {
		f19_local7,
	...
	f19_arg0.buttonLabels.BUTTON_Y = CoD.ButtonLayout.AddLeftAlignLabel(f19_arg0, f19_local7 + 5, f19_local8 + f19_local0)
	local f19_local9 = -170
	local f19_local10 = -23
	f19_arg0.buttonLines.BUTTON_LBUMP = CoD.ButtonLayout.AddLine(f19_arg0, {
		f19_local9,
		f19_local10
	}, {
		-130,
	...
	f19_arg0.buttonLabels.BUTTON_LBUMP = CoD.ButtonLayout.AddRightAlignLabel(f19_arg0, f19_local9 - 5, f19_local10 + f19_local0)
	local f19_local11 = 170
	local f19_local12 = -23
	f19_arg0.buttonLines.BUTTON_RBUMP = CoD.ButtonLayout.AddLine(f19_arg0, {
		130,
		-23
	}, {
		f19_local11,
	...
	f19_arg0.buttonLabels.BUTTON_RBUMP = CoD.ButtonLayout.AddLeftAlignLabel(f19_arg0, f19_local11 + 5, f19_local12 + f19_local0)
	if not CoD.isSinglePlayer then
		local f19_local13 = -205
		local f19_local14 = 110
		f19_arg0.buttonLines.BUTTON_UP = CoD.ButtonLayout.AddLine(f19_arg0, {
			f19_local13,
			f19_local14
		}, {
			-62,
		...
		f19_arg0.buttonLabels.BUTTON_UP = CoD.ButtonLayout.AddRightAlignLabel(f19_arg0, f19_local13 - 5, f19_local14 + f19_local0)
	end
	if not CoD.isSinglePlayer then
		local f19_local13 = -205
		local f19_local14 = 180
		f19_arg0.buttonLines.BUTTON_DOWN = CoD.ButtonLayout.AddLine(f19_arg0, {
			f19_local13,
			f19_local14
		}, {
			-62,
		...
		f19_arg0.buttonLabels.BUTTON_DOWN = CoD.ButtonLayout.AddRightAlignLabel(f19_arg0, f19_local13 - 5, f19_local14 + f19_local0)
	end
	local f19_local13 = -210
	local f19_local14 = 145
	f19_arg0.buttonLines.BUTTON_LEFT = CoD.ButtonLayout.AddLine(f19_arg0, {
		f19_local13,
		f19_local14
	}, {
		-83,
	...
	f19_arg0.buttonLabels.BUTTON_LEFT = CoD.ButtonLayout.AddRightAlignLabel(f19_arg0, f19_local13 - 5, f19_local14 + f19_local0)
	if not CoD.isSinglePlayer then
		local f19_local15 = -38
		local f19_local16 = 250
		f19_arg0.buttonLines.BUTTON_RIGHT = CoD.ButtonLayout.AddLine(f19_arg0, {
			-38,
			119
		}, {
			f19_local15,
		...
		f19_arg0.buttonLabels.BUTTON_RIGHT = CoD.ButtonLayout.AddCenterAlignLabel(f19_arg0, f19_local15, f19_local16)
	end
	local f19_local15 = -160
	local f19_local16 = -70
	f19_arg0.buttonLines.BUTTON_LTRIG = CoD.ButtonLayout.AddLine(f19_arg0, {
		f19_local15,
		f19_local16
	}, {
		-108,
	...
	f19_arg0.buttonLabels.BUTTON_LTRIG = CoD.ButtonLayout.AddRightAlignLabel(f19_arg0, f19_local15 - 5, f19_local16 + f19_local0)
	local f19_local17 = 160
	local f19_local18 = -70
	f19_arg0.buttonLines.BUTTON_RTRIG = CoD.ButtonLayout.AddLine(f19_arg0, {
		108,
		-40
	}, {
		f19_local17,
	...
	f19_arg0.buttonLabels.BUTTON_RTRIG = CoD.ButtonLayout.AddLeftAlignLabel(f19_arg0, f19_local17 + 5, f19_local18 + f19_local0)
	if not CoD.isSinglePlayer then
		local f19_local19 = -42
		local f19_local20 = -135
		f19_arg0.buttonLines.BUTTON_BACK = CoD.ButtonLayout.AddLine(f19_arg0, {
			-42,
			48
		}, {
			f19_local19,
		...
		f19_arg0.buttonLabels.BUTTON_BACK = CoD.ButtonLayout.AddCenterAlignLabel(f19_arg0, f19_local19, f19_local20 - CoD.textSize.Default)
	end
	local f19_local19 = 42
	local f19_local20 = -100
	f19_arg0.buttonLines.BUTTON_START = CoD.ButtonLayout.AddLine(f19_arg0, {
		42,
		48
	}, {
		f19_local19,
	...
	f19_arg0.buttonLabels.BUTTON_START = CoD.ButtonLayout.AddCenterAlignLabel(f19_arg0, f19_local19, f19_local20 - CoD.textSize.Default)
	local f19_local21 = -190
	local f19_local22 = 52
	f19_arg0.buttonLines.BUTTON_LSTICK = CoD.ButtonLayout.AddLine(f19_arg0, {
		f19_local21,
		f19_local22
	}, {
		-120,
	...
	f19_arg0.buttonLabels.BUTTON_LSTICK = CoD.ButtonLayout.AddRightAlignLabel(f19_arg0, f19_local21 - 5, f19_local22 + f19_local0)
	local f19_local23 = 56
	local f19_local24 = 220
	f19_arg0.buttonLines.BUTTON_RSTICK = CoD.ButtonLayout.AddLine(f19_arg0, {
		56,
		123
	}, {
		f19_local23,
	...
	f19_arg0.buttonLabels.BUTTON_RSTICK = CoD.ButtonLayout.AddCenterAlignLabel(f19_arg0, f19_local23, f19_local24)
end
