...
CoD.DistFieldText.new = function (f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6)
	...
	local f1_local6 = 50
	local f1_local7 = LUI.UIText.new(f1_arg0)
	f1_local7:registerAnimationState("default_shader_state", {
		font = CoD.fonts.Dist,
	...
	f1_local2 = f1_arg1
	f1_local5 = f1_arg2
	f1_local7:registerAnimationState("pulse_in", {
		shaderVector0 = f1_local0,
		shaderVector1 = f1_local1,
		shaderVector2 = f1_local2,
		shaderVector3 = f1_local3,
	...
	f1_local7:registerAnimationState("pulse_out", {
		shaderVector0 = f1_local0,
		shaderVector1 = f1_local1,
		shaderVector2 = f1_local2,
		shaderVector3 = f1_local3,
	...
	f1_local7.pulseIn = CoD.DistFieldText.PulseIn
	f1_local7.pulseOut = CoD.DistFieldText.PulseOut
	f1_local7.setupForWarningPulse = CoD.DistFieldText.SetupForWarningPulse
	f1_local7.startWarningPulse = CoD.DistFieldText.StartWarningPulse
	f1_local7:pulseIn()
