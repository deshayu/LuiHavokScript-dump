...
LUI.createMenu.KeyboardTextField = function (f2_arg0, f2_arg1)
	...
	Widget:setLeftRight(true, true, f2_local4, -f2_local4)
	Widget:setTopBottom(true, false, f2_local9, f2_local9 + f2_local8)
	Widget:setUseStencil(true)
	f2_local0:addElement(Widget)
	...
	Widget:addElement(f2_local0.inputText)
	...
	Widget:addElement(f2_local0.cursorText)
	f2_local0.cursor = "|"
