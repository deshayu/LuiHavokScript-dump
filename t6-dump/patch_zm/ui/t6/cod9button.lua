...
CoD.CoD9Button.new = function (f15_arg0, f15_arg1, f15_arg2)
	...
	f15_local0.showZMNewIcon = CoD.CoD9Button.ShowZMNewIcon
...
CoD.CoD9Button.NewRegistrationButton = function (f22_arg0, f22_arg1, f22_arg2, f22_arg3)
	local f22_local0 = LUI.UIButton.new(f22_arg0, f22_arg1)
	f22_local0.id = "CoD9RegistrationButton"
	f22_local0.setLabel = CoD.CoD9Button.RegistrationButtonSetLabel
	f22_local0.lock = CoD.CoD9Button.Lock
	f22_local0.showNewIcon = CoD.CoD9Button.ShowNewIcon
	f22_local0.showZMNewIcon = CoD.CoD9Button.ShowZMNewIcon
	f22_local0.showRestrictedIcon = CoD.CoD9Button.ShowRestrictedIcon
	f22_local0.addBackground = CoD.CoD9Button.AddBackgroundElement
	f22_local0:registerEventHandler("disable_input", CoD.CoD9Button.DisableInput)
	f22_local0:registerEventHandler("enable_input", CoD.CoD9Button.EnableInput)
	f22_local0:registerEventHandler("gain_focus", CoD.CoD9Button.GainFocus)
	f22_local0:registerEventHandler("lose_focus", CoD.CoD9Button.LoseFocus)
	...
	f22_local0:registerAnimationState("pulse_high", {
		alpha = 1
	})
	f22_local0:registerAnimationState("pulse_low", {
		alpha = 0.5
	})
	f22_local0:registerAnimationState("pulse_high_disabled", {
		alpha = f22_local1
	})
	f22_local0:registerAnimationState("pulse_low_disabled", {
		alpha = f22_local2
	})
	f22_local0:registerEventHandler("transition_complete_pulse_high", CoD.CoD9Button.TransitionCompletePulseHigh)
	f22_local0:registerEventHandler("transition_complete_pulse_low", CoD.CoD9Button.TransitionCompletePulseLow)
	f22_local0:registerEventHandler("transition_complete_pulse_high_disabled", CoD.CoD9Button.TransitionCompletePulseHigh)
	f22_local0:registerEventHandler("transition_complete_pulse_low_disabled", CoD.CoD9Button.TransitionCompletePulseLow)
	f22_local0.container = LUI.UIElement.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f22_local0:addElement(f22_local0.container)
	f22_local0.backgroundContainer = LUI.UIElement.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f22_local0:addElement(f22_local0.backgroundContainer)
	if CoD.isZombie == true then
		f22_local0.brackets = CoD.SideBracketsImage.new()
		f22_local0.brackets:setAlpha(0)
		f22_local0.container:addElement(f22_local0.brackets)
	end
	...
	f22_local0.label = LUI.UIText.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 6,
		right = 0,
	...
	CoD.CoD9Button.SetupTextElement(f22_local0.label)
	f22_local0:addElement(f22_local0.label)
	f22_local0.border = CoD.Border.new(1, 1, 1, 1, 0.1)
	f22_local0.border:registerEventHandler("button_over", CoD.CoD9Button.RegistrationButtonOver)
	f22_local0.border:registerEventHandler("button_up", CoD.CoD9Button.RegistrationButtonUp)
	f22_local0:addElement(f22_local0.border)
	local f22_local6 = 4
	...
	f22_local0.backgroundContainer:addElement(f22_local8)
	return f22_local0
end
